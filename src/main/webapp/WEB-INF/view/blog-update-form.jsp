        ...
        <div id="page-wrapper">
            ...
            <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
                ...
                <c:import url="admin-sidebar.jsp">
                	 <c:param name="user" value="${userPrincipal}" />
                </c:import>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    Blog update form<br><small>Update existing blog</small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="block">
                                    ...
                                    <section>
                                     ...
                                     <form:form action="blog-update-save" modelAttribute="blog" id="form-validation" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                           <form:hidden path="id_blog_product"/>
                                            <form:hidden path="date_created"/>
                                             <form:hidden path="date_modified"/>
                                             <form:hidden path="visit_count"/>
                                             <form:hidden path="comment_count"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <!-- More info can be found at http://ckeditor.com -->
                                                 <form:textarea type="textbox" id="content" path ="content" name="content" class="form-control" placeholder="Enter blog content..."/>
                                            </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <form:select path="tags" itemLabel="tag_name" itemValue="id_tag" items="${tagList}" class="select-chosen" data-placeholder="Choose tags.." style="width: 250px; display: none;" />
                                                       <div><form:errors path="tags" cssClass="text-danger" /> </div>
                                            </div>
                                              <div><form:errors path="tags" cssClass="text-danger" /> </div>
                                        </div>
