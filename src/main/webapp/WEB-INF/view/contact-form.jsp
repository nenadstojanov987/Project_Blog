...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Contact info - welcome to Admin page</title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    Contact form<br><small>Manage contact info</small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="block full">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Contact info elements</strong> </h2>
                                    </div>
                                    <!-- END Form Validation Example Title -->

                                    <!-- Form Validation Example Content -->
                                 
                                    <form:form id="form-validation" action="contact-save" modelAttribute="contact" method="post" class="form-horizontal form-bordered">
                                        <form:hidden path="id_contact"/>
                                        <fieldset>
                                       
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="val_title">Our adress <span class="text-danger">*</span>
                                                <br>
                                                <div><form:errors path="adress" cssClass="error" /> </div>
                                                </label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <form:input path="adress" type="text" id="val_title" name="val_title" class="form-control" placeholder="Enter slider title..."/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <div><form:errors path="phone_number" cssClass="error" /> </div>
                                                </label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                             ...
                                             <div class="form-group ">
                                                <label class="col-md-4 control-label" for="val_url">E-mail adress <span class="text-danger">*</span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <form:input path="email" type="text" id="val_url" name="val_url" class="form-control"/>
             											 ...
             											 <div class="information">
								                                ...
								                                <div class="block">
								                                    ...
								                                    <div class="alert alert-success alert-dismissable">
								                                        ...
								                                        <h4><i class="fa fa-check-circle"></i> Success</h4> ${message}!
								                                    </div>
