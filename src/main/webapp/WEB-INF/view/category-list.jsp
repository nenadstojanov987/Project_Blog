...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Category list- welcome to Admin page</title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                       		<div class="header-section">
                       			 <h1>
                                    Category list<br><small>View and manage existing categories</small>
                                </h1>
                                
                            <ul class="nav-horizontal text-center">
                                <li class="active">
                                    <a href="category-form"><i class="gi gi-folder_new"></i> Add new Category</a>
                                </li>
                        ...
                        <div class="block full">
                            <div class="block-title">
                                <h2><strong>Category list</strong> preview</h2>
                            </div>
                                ...
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <c:forEach var="category" items="${categoryList}">
                                     <tr>
	                                            ...
	                                            <td class="text-justify">${category.category_description}</td>
	                                            <td class="text-center">${category.category_priority}</td>
	                                            <td class="text-center"><a href="${pageContext.request.contextPath}/blog-post-category/${category.category_name}/${category.id_category}">${category.id_category}_${category.category_name}</a>
	                               				<sec:authorize access="hasRole('admin')">
	                                            <c:choose>
	                                            <c:when test="${category.id_category!=1}">
	                                            <td class="text-center">
	                                                <div class="btn-group">
	                                                    <a href="category-update?id_category=${category.id_category}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
	                                                       
	                                                    <a href="category-delete?id_category=${category.id_category}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" onclick="if(!(confirm('Do you want do delete this category?'))) return false"><i class="fa fa-times"></i></a>
	                                            ...
	                                            <td class="text-center">
	                                                <div class="btn-group">
	                                                    <label data-toggle="tooltip"  ><i class="fa fa-pencil"></i></label>
	                                                       
	                                                    <label data-toggle="tooltip"  ><i class="fa fa-times"></i></label>
