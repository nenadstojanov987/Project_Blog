...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Tag list- welcome to Admin page</title>
    ...
    <body>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                       		<div class="header-section">
                       			 <h1>
                                    Tag list<br><small>View and manage existing tags</small>
                                </h1>
                                
                            <ul class="nav-horizontal text-center">
                                <li class="active">
                                    <a href="tag-form"><i class="gi gi-tag"></i> Add new Tag</a>
                                </li>
                        ...
                        <div class="block full">
                            <div class="block-title">
                                <h2><strong>Tag list</strong> preview</h2>
                            </div>
                                    ...
                                    <c:forEach var="tag" items="${tagList}">
                                     <tr>
	                                            ...
	                                            <td class="text-center">${tag.tag_name}</td>
	                                             <td class="text-center"><a href="${pageContext.request.contextPath}/blog-post-tags/${tag.tagSeoName}/${tag.id_tag}">${tag.id_tag}_${tag.tag_name}</a></td>
	                                            
	                               				 <sec:authorize access="hasRole('admin')">
		                                            <td class="text-center">
		                                                <div class="btn-group">
		                                                    <a href="tag-update?id_tag=${tag.id_tag}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
		                                                       
		                                                    <a href="tag-delete?id_tag=${tag.id_tag}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" onclick="if(!(confirm('Do you want do delete this tag?'))) return false"><i class="fa fa-times"></i></a>
        ...
        <script src="${pageContext.request.contextPath}/admin/js/pages/tablesDatatables2.js"></script>
