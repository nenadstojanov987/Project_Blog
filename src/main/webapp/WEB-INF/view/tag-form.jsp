...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Tag form - welcome to Admin page</title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    Tag form<br><small>Add new or edit existing tags</small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="block full">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Tag element</strong> </h2>
                                    </div>
                                    <!-- END Form Validation Example Title -->

                                    <!-- Form Validation Example Content -->
                                 
                                    <form:form id="form-validation" action="tag-save" modelAttribute="tag" method="post" class="form-horizontal form-bordered">
                                        <form:hidden path="id_tag"/>
                                        <fieldset>
                                       
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="val_title">Tag name<span class="text-danger">*</span>
                                                <br>
                                                <div><form:errors path="tag_name" cssClass="text-danger" /> </div>
                                                </label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <form:input path="tag_name" type="text" id="tag_name" name="tag_name" class="form-control" placeholder="Enter tag name..."/>
