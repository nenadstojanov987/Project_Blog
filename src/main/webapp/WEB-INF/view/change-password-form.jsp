                        ...
                        <div class="row">
                            <div class="block full">
                                ...
                                <div class="block">
                                    ...
                                    <form:form role="form" modelAttribute="passwordChange" action="change-mypassword-save"  class="form-horizontal form-bordered">
                                         
                                        <fieldset>
                                       
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="val_title">Old password <span class="text-danger">*</span>
                                                <br>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="val_title">New password <span class="text-danger">*</span>
                                                <br>
                                                <div><form:errors path="newPassword" cssClass="error" /> </div>
                                                </label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                             ...
                                             <div class="form-group">
                                                <label class="col-md-4 control-label" for="val_title">Confirm password <span class="text-danger">*</span>
                                                <br>
                           						 ...
                           						 <c:if test="${success==2}">
							                                ...
							                                <div class="block">
							                                    ...
							                                    <div class="alert alert-warning alert-dismissable">
							                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							                                        <h4><i class="fa fa-exclamation-circle"></i> Warning</h4>${message}!
							                                    </div>
							                            ...
							                            <div class="information">
								                                ...
								                                <div class="block">
								                                    ...
								                                    <div class="alert alert-info alert-dismissable">
								                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								                                        <h4><i class="fa fa-info-circle"></i> Info</h4> Welcome to password change form. Please enter your new password.
								                                    </div>
