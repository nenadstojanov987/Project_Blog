                        ...
                        <div class="row">
                            <div class="block full">
                                ...
                                <div class="block">
                                    ...
                                    <form:form id="form-validation" action="user-update" modelAttribute="userToUpdate" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        
                                       	<form:hidden path="password"/> 
									     <form:hidden path="username"/>  
									     <c:if test="${userToUpdate.image!=null}">
                                       ...
                                       <fieldset>
                                        ...
                                        <div class="widget">
                                       <a href="#" class="themed-color-modern">
                                                <strong>Update user: ${userToUpdate.username}</strong>
                                            </a>
                                            <img src="${pageContext.request.contextPath}/${userToUpdate.image}" alt="avatar" class="widget-image img-circle pull-left">
                                        ...
                                        <h4 class="widget-content text-right">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <div><form:errors path="surname" cssClass="error"/> </div>
                                                </label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                           ...
                                           <sec:authorize access="hasRole('admin')">
                                             <div class="form-group">
							                         <label class="col-md-4 control-label" for="val_digits">Select Role <span class="text-danger">*</span>
                                           			 ...
                                           			 <br>
                                           			 <div><form:errors path="roles" cssClass="error" /> </div>
                                              		</label>
                                              		<div class="col-md-6">
                                                ...
                                                <div class="col-md-8">
 												...
 												<form:checkbox class="form-control" path="enabled" placeholder="Enable/Disable user for login" />  
